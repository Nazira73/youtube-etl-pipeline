import json
 ...
 def get_videos_df(client, bucket_name):
     response = client.list_objects_v2(Bucket=bucket_name, Prefix='extracted_data/videos/processed/')
 ...
 def get_comments_df(client, bucket_name):
     response = client.list_objects_v2(Bucket=bucket_name, Prefix='extracted_data/comments/')
